...
/****************************** Module Header ******************************\
Module Name     :   ComplexPropertyMethodToValueConverter.cs
Project         :   Air To Galaxy Test Harness
Author          :   Romy Thomas

Complex object to value converter for JSON tree view
\***************************************************************************/
namespace GalaxyToAir_TestHarness.ValueConverters
{
